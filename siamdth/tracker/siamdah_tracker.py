...
from siamdth.tracker.base_tracker import SiameseTracker
from siamdth.utils.bbox import corner2center


class SiamDTHTracker(SiameseTracker):
    def __init__(self, model):
        super(SiamDTHTracker, self).__init__()
