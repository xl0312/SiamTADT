...
def load_pretrain(model, pretrained_path):
    ...
    #torch.save(model.state_dict(), '/home/cs512/jixie/centerness_threeattention/siamdth-master/experiments/siamban_r50_l234/snapshot/checkpoint_e20.pth', _use_new_zipfile_serialization=False)
    return model
