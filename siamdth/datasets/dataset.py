...
from siamdth.utils.bbox import center2corner, Center
from siamdth.datasets.point_target import PointTarget
from siamdth.datasets.augmentation import Augmentation
...
class SubDataset(object):
    ...
    def get_image_anno(self, video, track, frame):
        ...
        image_path = os.path.join(self.root, video1,
...
class BANDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # get labels
        centercls = np.zeros((cfg.TRAIN.OUTPUT_SIZE, cfg.TRAIN.OUTPUT_SIZE), dtype=np.int64)
        ...
        return {
                ...
                'bbox': np.array(bbox),
                'centercls': centercls,
                'CARbbox': np.array([bbox.x1, bbox.y1, bbox.x2, bbox.y2])
                }
